    ...
    public function neraca(Request $request)
{
    ...
    $nama_perusahaan = $perusahaanAktif->nama_perusahaan ?? '-';
    ...
    $jurnal = JurnalDetail::selectRaw('coa_id, SUM(debit) as total_debit, SUM(kredit) as total_kredit')
    ...
    return view('laporan.neraca_psak', compact(
