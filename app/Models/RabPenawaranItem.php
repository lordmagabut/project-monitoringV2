...
class RabPenawaranItem extends Model
{
    ...
    protected $fillable = [
        ...
        'satuan',
        'harga_satuan_dasar',
        'harga_satuan_calculated', // <<< PASTIKAN INI ADA
        'harga_satuan_penawaran',
        'total_penawaran_item',
        'harga_material_dasar_item',
        'harga_upah_dasar_item',
        'harga_material_calculated_item', // <<< PASTIKAN INI ADA
        'harga_upah_calculated_item',     // <<< PASTIKAN INI ADA
        'harga_material_penawaran_item',  // <<< PASTIKAN INI ADA
        'harga_upah_penawaran_item',      // <<< PASTIKAN INI ADA
    ];
