      ...
      <div class="card-body">
        ...
        <form action="{{ route('pemberiKerja.update', $pemberiKerja->id) }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="pic" class="form-control" value="{{ $pemberiKerja->pic }}" required>
          </div>
          ...
          <div class="mb-3">
            ...
            <textarea name="alamat" class="form-control" rows="3">{{ $pemberiKerja->alamat }}</textarea>
          </div>

          <button type="submit" class="btn btn-primary">Update</button>
          <a href="{{ route('pemberiKerja.index') }}" class="btn btn-secondary">Kembali</a>
        </form>
      </div>
    </div>
  </div>
