                    ...
                    <table class="table table-bordered" id="barang-table">
                        ...
                        <tbody id="detail-barang">
                            <tr>
                                ...
                                <td><input type="text" name="items[0][uraian]" class="form-control uraian" required></td>
                                <td><input type="number" step="0.01" name="items[0][qty]" class="form-control qty" min="0" required></td>
                                <td><input type="text" name="items[0][uom]" class="form-control" required></td>
                                <td><input type="number" name="items[0][harga]" class="form-control harga" min="0" required></td>
