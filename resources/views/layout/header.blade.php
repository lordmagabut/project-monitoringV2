        ...
        <li class="nav-item {{ active_class(['email/*', 'apps/*']) }}">
          ...
          <div class="submenu">
            <ul class="submenu-item">
              <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/perusahaan/') }}">Daftar Perusahaan</a></li>
              <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/supplier/') }}">Daftar Supplier</a></li>
              <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/pemberiKerja/') }}">Daftar Pemberi Kerja</a></li>
              <li class="nav-item"><a class="nav-link {{ active_class(['email/inbox']) }}" href="{{ url('/proyek/') }}">Daftar Proyek</a></li>
